      ...
      {isVisible && (
        ...
        >
          ...
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="absolute inset-0 bg-gradient-to-br from-primary/90 via-primary/80 to-destructive/70 backdrop-blur-md"
          ...
          >
            ...
            <motion.button
              ...
              onClick={() => handleDismiss(false)}
              className="absolute -top-2 -right-2 p-2 rounded-full bg-white/20 hover:bg-white/30 text-white transition-colors z-20"
            >
              <X className="w-5 h-5" />
            </motion.button>
            ...
            <div className="text-center text-white">
              ...
              <motion.p 
                variants={itemVariants}
                className="text-white/80 text-base sm:text-lg mb-8 max-w-md mx-auto"
              >
              ...
              >
                <Button
                  ...
                  className={cn(
                    ...
                    "touch-target touch-scale group"
                  )}
                >
              ...
              >
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div 
                      key={i} 
                      className="w-7 h-7 rounded-full bg-white/30 border-2 border-white/50 flex items-center justify-center text-xs font-bold"
                    >
